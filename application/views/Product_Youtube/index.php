<div>
    <h2 class="page-head-title">จัดการ Youtube</h2>
...
<div class="row" id="vue-root">
    ...
    <vs-popup class="holamundo" title="Youtube" :active.sync="popupActive">
        <v-row>
            <vs-input label-placeholder="Link Youtube" type="text" v-model="field.LINK" size="large" />
        </v-row>
