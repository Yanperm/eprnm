        ...
        <div class="card card-table">
            <div class="row table-filters-container">
                <div class="col-12 col-lg-12 col-xl-6">
                    <div class="row">
                        <div class="col-12 col-lg-6 table-filters pb-0 pb-xl-4"><span class="table-filter-title">ค้นหาบริษัทที่รับตรวจแล็บ</span>
                            ...
                            <div class="filter-container">
                                ...
                                <form>
                                    <at-select v-model="conditionType" size="large" @on-change="makePageData">
                                        <at-option value="1">รหัสบริษัทที่รับตรวจแล็บ</at-option>
                                        <at-option value="2">ชื่อบริษัทที่รับตรวจแล็บ</at-option>
                                    </at-select>
                                </form>
                            </div>
                        </div>
...
<script type="text/javascript">
    const app = new Vue({
        ...
        methods: {
            makePageData() {
                axios.get("<?php echo base_url('labCompany/getLabCompany');?>", {
                        params: {
                            search: this.search,
