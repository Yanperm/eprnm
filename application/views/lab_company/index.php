...
<div class="row" id="vue-root">
                                        ...
                                        <div class="centerx">
                                            <vs-tooltip text="แก้ไขข้อมูล">
                                                <vs-button color="rgba(112, 128, 144, 0.25)" type="filled"
                                                    ...
                                                    @click="editDialog(data[indextr].LabCID)"></vs-button>
                                            </vs-tooltip>
    ...
    <vs-popup class="holamundo" title="ผู้รับตรวจ" :active.sync="popupActive">
        <v-row>
            <vs-input label-placeholder="รหัสผู้รับตรวจ" type="text" v-model="code" size="large" readonly />
        </v-row>
        <br>
        <v-row>
            <vs-input label-placeholder="ชื่อผู้รับตรวจ" type="text" v-model="name" size="large" />
        </v-row>
