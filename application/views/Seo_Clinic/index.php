<div>
    <h2 class="page-head-title">จัดการ SEO</h2>
...
<div class="row" id="vue-root">
                        ...
                        <vs-table :sst="true" @sort="handleSort" v-model="selected" :total="totalItems" :max-items="perPage" :data="recordData">
                            ...
                            <template slot-scope="{data}">
                                <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data" >
                                    <vs-td :data="data[indextr].SEO_TITLE">
                                        {{data[indextr].SEO_TITLE}}
                                    </vs-td>

                                    <vs-td :data="data[indextr].SEO_META">
                                        {{data[indextr].SEO_META}}
                                    </vs-td>
    ...
    <vs-popup class="holamundo" title="SEO" :active.sync="popupActive">
        <v-row>
        </br>
            <label for="inputCode">Title</label>
            <vs-input label-placeholder="" type="text" v-model="field.SEO_TITLE" size="large" />
        </v-row>
        <v-row>
            </br>
            <label for="inputCode">Meta</label>
            <vs-input label-placeholder="" type="text" v-model="field.SEO_META" size="large" />
        </v-row>
